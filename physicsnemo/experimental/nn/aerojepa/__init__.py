...
Reusable layers for the AeroJEPA framework: attention blocks, geometry
tokenizer, context and target encoders, decoder, and predictor. These are
exposed for composition by users who want to build JEPA-style architectures
for steady 3D aerodynamic surrogate modeling independently of the full
``AeroJEPA`` model class.
